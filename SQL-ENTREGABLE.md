# 📄 Script SQL para Configurar Múltiples Chatbots

**Ejecuta este código completo en tu panel de Supabase:**
...
-- Verificar si la tabla 'users' existen antes de crear la foreign key
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'users') THEN
        -- La tabla users existe, podemos crear la foreign key
        EXECUTE 'ALTER TABLE whatsapp_authorized_users ADD CONSTRAINT IF NOT EXISTS fk_whatsapp_users FOREIGN KEY (user_id) REFERENCES users(id)';
    END IF;
END $$;

-- Insertar configuración de chatbots
...
('+573014241183', 1, 'admin', '+573014241183', 'Número Colombia', 'CO'),
('573014241183', 1, 'admin', '+573014241183', 'Número Colombia (sin +)', 'CO'),

-- Usuarios autorizados para Chatbot Secundario España
('+34661613025', 1, 'admin', '+34661613025', 'Número Secundario España', 'ES'),
('34661613025', 1, 'admin', '+34661613025', 'Número Secundario España (sin +)', 'ES')
...
4. Copia TODO el código SQL de arriba
5. Pégalo en el editor
6. Haz clic en **"Run"**

### **Resultado esperado:**
- ✅ Se crearán las tablas necesarias
- ✅ Se insertarán los datos de configuración
- ✅ Verás un mensaje de éxito
- ✅ Se mostrará un resumen de la configuración
