-- Test Data Simple para Dashboard - Contas-PT Cloud
-- Este script inserta datos de forma secuencial para evitar problemas de referencias
...
-- 9. PAGAMENTOS (4 pagamentos para faturas pagas) - INSERTAR DESPUÉS DE LAS FATURAS
-- Primero obtener los IDs de las faturas pagas y luego insertar los pagos
DO $$
DECLARE
