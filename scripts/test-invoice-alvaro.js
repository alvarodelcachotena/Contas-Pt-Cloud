...
console.log('🧪 Testando Criação de Fatura para Alvaro...\n')

const testMessage = 'creale una factura al cliente alvaro y guardala en base de datos y enviale un email con la factura, valor base 1230, tax de 23%'
